            ...
            <a href="<?php echo $list_product ?>"><button class="btn btn-primary d-flex ">Back</button></a>
                ...
                <div class="card-body">
                    ...
                    <div class="col-xl-10">
                        ...
                        <div class="mb-3">
                        <label for="exampleFormControlInput5">Brand: <?php echo $data['brand']; ?> </label>
                    
                        </div>
                        <div class="mb-3"><label for="exampleFormControlInput5">Material: <?php echo $data['material'] ?></label></div>
                        <div class="mb-3"><label for="exampleFormControlInput4">Category: <?php if($data['category'] == 'best-selling'){
                            echo 'Best Selling';
                            }else if($data['category'] == 'new-arrivals'){
                            echo 'New Arrivals';
                            }else{
                                echo 'Hot Sales';
                            }?></label></div>
